...
\begin{itemize}
  ...
  \item "\texttt{end\_i}": The end frame of the video segment the bounding boxes are created for (if is\_split\_url is true)
...
\begin{figure}[htpb]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Videos in dataset grouped by object class}
...
\begin{figure}[htpb]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Videos in dataset grouped by number of participants}
...
\begin{figure}[htpb]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Videos in dataset grouped by number of agents}
...
\begin{figure}[htpb]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Videos in dataset grouped by duration}
		\label{fig:vids-by-duration}
\end{figure}

\begin{figure}[htpb]
		\centering
    \includegraphics[width=3in,trim={0 1cm 0 1cm},clip]{by-collision.png}
...
\begin{figure}[htpb]
		\centering
    \includegraphics[width=3in,trim={0 1cm 0 1cm},clip]{by-camera.png}
