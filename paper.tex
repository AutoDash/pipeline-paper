...
However, we can collect collision data naturally in real driving scenarios through the use of dash-cams - cheap video cameras that can be mounted to a car's dashboard.
