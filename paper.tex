...
\begin{figure}[htbp]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Distribution of videos in dataset by object class}
...
\begin{figure}[htbp]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Distribution of videos in dataset by number of participants}
...
\begin{figure}[htbp]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Distribution of videos in dataset by number of agents}
...
\begin{figure}[htbp]
    ...
    \end{axis}
    \end{tikzpicture}
		\caption{Distribution of videos in dataset by duration}
		\label{fig:vids-by-duration}
\end{figure}

\begin{figure}[htbp]
		\centering
    \includegraphics[width=0.46\textwidth,trim={0 1cm 0 0.5cm},clip]{by-collision.png}
...
\begin{table}[htbp]
	\caption{Distribution of videos in dataset by geographical region}
...
\todo{Add Figure 11 (table) showing videos by source (98.4\% YouTube, 0.47\% gfycat.com, 0.85\% imgur.com, 0.28\% streamable.com)}
